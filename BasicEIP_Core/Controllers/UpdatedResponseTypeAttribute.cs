...
namespace BasicEIP_Core.Controllers
{
    ...
    public class UpdatedResponseTypeAttribute : Attribute, IFilterMetadata
    {
        /// <summary>
        /// 定義 API 回應的類型。
        /// </summary>
        ...
        public UpdatedResponseTypeAttribute(Type responseType)
        {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            context.Filters.Add(new ProducesResponseTypeAttribute(ResponseType, 200)); // 更新成功
