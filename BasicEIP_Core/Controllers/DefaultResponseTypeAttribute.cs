...
{
    /// <summary>
    /// 自訂屬性，用於設定方法的預設回應類型和狀態碼。
    /// </summary>
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = false)]
    public class DefaultResponseTypeAttribute : Attribute, IFilterMetadata
    {
        /// <summary>
        /// 定義 API 回應的類型。
        /// </summary>
        ...
        public DefaultResponseTypeAttribute(Type responseType)
        {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            context.Filters.Add(new ProducesResponseTypeAttribute(ResponseType, 200)); // 成功
